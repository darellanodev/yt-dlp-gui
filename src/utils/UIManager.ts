export class UIManager {
  ...
  constructor() {
    ...
    this.resultsTextarea = document.getElementById('Results') as HTMLTextAreaElement;
    this.typeRadio = Array.from(document.getElementsByName('type')).map(e => e as HTMLInputElement);
    this.qualityRadio = Array.from(document.getElementsByName('quality')).map(e => e as HTMLInputElement);
